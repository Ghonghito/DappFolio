...
const Index = () => {
  ...
  return (
    <div className='flex'>
      <div onClick={() => setDarkMode()} className='duration-150 hover:scale-95 ml-2 bg-primary hover:bg-primaryDark bg-pos-0 hover:bg-pos-100 p-2 rounded-lg cursor-pointer'>
