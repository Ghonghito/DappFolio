			...
			returnValue = (
				<div key={key} className='mt-1'>
					<NavLink exact='true' to={path}>
						<div className={`${active ? 'bg-primary dark:bg-primary shadow-lg' : ''} group flex items-center space-x-2 cursor-pointer duration-150 hover:bg-primary dark:hover:bg-darkCard w-full h-[50px] px-2 rounded-md`}>
