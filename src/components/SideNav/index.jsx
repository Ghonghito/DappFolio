	...
	return (
		<div>
			...
			<div className='md:flex'>
				<div className='hidden lg:flex h-screen sticky overflow-y-hidden top-0 flex-col p-4 duration-150 border-r border-lightHover dark:border-darkCard min-h-screen w-[250px]'>
					<a href='/'>
